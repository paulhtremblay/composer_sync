...
def _get_args():
    ...
    parser.add_argument('--delete-from-bucket', action='store_true')
...
def _get_storage_d(
        ...
        verbosity:int = 0)-> dict:
    d = {}
    g = list_blobs(storage_client = storage_client, bucket_name = bucket_name)
    for i in g:
